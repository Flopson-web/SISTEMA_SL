        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-700 dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                <div class="bg-gray-800 dark:bg-gray-700 border border-yellow-400 rounded-lg p-6 shadow-lg text-white">
                    ...
                    <div class="mb-4">
                        <a href="{{ route('students.create') }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Create Student</a>
                    </div>

                    <!-- Lista de Estudiantes -->
                    <div class="space-y-4">
                        @foreach($students as $student)
                            <div class="relative bg-gray-900 hover:bg-white text-white hover:text-gray-900 border border-yellow-500 hover:border-red-500 rounded-lg shadow-lg p-6 transition-all duration-300">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <div class="flex justify-between mt-4">
                                        ...
                                        <button type="button" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onclick="confirmDelete('{{ $student->id }}')">Delete</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
