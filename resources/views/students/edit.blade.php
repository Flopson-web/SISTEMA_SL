    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                ...
                <form method="POST" action="{{ route('students.update', $students->id) }}" class="max-w-sm mx-auto">
                    @csrf
                    @method('PUT')

                    <div class="mb-5">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre</label>
                        <input type="text" name="name" id="name" value="{{ old('nombre', $students->nombre) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>

                    <div class="mb-5">
                        <label for="lastname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Apellido</label>
                        <input type="text" name="lastname" id="lastname" value="{{ old('apellido', $students->apellido) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" name="age" id="age" value="{{ old('edad', $students->edad) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>      

                    <div class="mb-5">
                        <label for="nro_de_lista" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nro de Lista</label>
                        <input type="text" name="nro_de_lista" id="nro_de_lista" value="{{ old('nro_de_lista', $students->nro_de_lista) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class="mb-5">
                        <label for="nombre_padre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre del Padre</label>
                        <input type="text" name="nombre_padre" id="nombre_padre" value="{{ old('nombre_padre', $students->nombre_padre) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class="mb-5">
                        <label for="trabajo_padre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Trabajo del Padre</label>
                        <input type="text" name="trabajo_padre" id="trabajo_padre" value="{{ old('trabajo_padre', $students->trabajo_padre) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class="mb-5">
                        <label for="celular_padre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Celular del Padre</label>
                        <input type="text" name="celular_padre" id="celular_padre" value="{{ old('celular_padre', $students->celular_padre) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class="mb-5">
                        <label for="nombre_madre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre de la Madre</label>
                        <input type="text" name="nombre_madre" id="nombre_madre" value="{{ old('nombre_madre', $students->nombre_madre) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class="mb-5">
                        <label for="trabajo_madre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Trabajo de la Madre</label>
                        <input type="text" name="trabajo_madre" id="trabajo_madre" value="{{ old('trabajo_madre', $students->trabajo_madre) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class="mb-5">
                        <label for="celular_madre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Celular de la Madre</label>
                        <input type="text" name="celular_madre" id="celular_madre" value="{{ old('celular_madre', $students->celular_madre) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="number" name="hermanos_en_colegio" id="hermanos_en_colegio" value="{{ old('hermanos_en_colegio', $students->hermanos_en_colegio) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class="mb-5">
                        <label for="direccion_actual" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dirección Actual</label>
                        <input type="text" name="direccion_actual" id="direccion_actual" value="{{ old('direccion_actual', $students->direccion_actual) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class="mb-5">
                        <label for="telefono_casa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Teléfono de Casa</label>
                        <input type="text" name="telefono_casa" id="telefono_casa" value="{{ old('telefono_casa', $students->telefono_casa) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="celular_estudiante" id="celular_estudiante" value="{{ old('celular_estudiante', $students->celular_estudiante) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="lugar_trabajo" id="lugar_trabajo" value="{{ old('lugar_trabajo', $students->lugar_trabajo) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>

                    <div class="mb-5">
                        <label for="nro_dosis_covid" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nro Dosis Covid</label>
                        <input type="number" name="nro_dosis_covid" id="nro_dosis_covid" value="{{ old('nro_dosis_covid', $students->nro_dosis_covid) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <select name="vive_con" id="vive_con" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <option value="Tíos" {{ old('vive_con', $students->vive_con) == 'Tíos' ? 'selected' : '' }}>Tíos</option>
                    ...
                    <div class="mb-5">
                        ...
                        <select name="religion" id="religion" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="Católica" {{ old('religion', $students->religion) == 'Católica' ? 'selected' : '' }}>Católica</option>
                            <option value="Evangélica" {{ old('religion', $students->religion) == 'Evangélica' ? 'selected' : '' }}>Evangélica</option>
